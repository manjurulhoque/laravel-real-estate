        ...
        <div class="container">
            ...
            <div class="my-profile__container">
                <div class="row">
                    ...
                    <form action="{{ route('my.properties.update', $property->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-9">
                            <div class="submit-property__block">
                                ...
                                <div class="submit-property__group">
                                    ...
                                    <input type="text" name="title" value="{{ $property->title }}"
                                           class="submit-property__field" id="property-title"
                                    ...
                                    <div class="col-md-4">
                                        <div class="submit-property__group">
                                            ...
                                            <select class="ht-field" name="type" id="property-type" required>
                                                <option value="Single Bed" {{ $property->type == 'Single Bed' ? 'selected' : '' }}>
                                                    Single Bed
                                                </option>
                                                <option value="Single Room" {{ $property->type == 'Single Room' ? 'selected' : '' }}>
                                                    Single Room
                                                </option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="submit-property__group">
                                            ...
                                            <select class="ht-field" name="offer" id="property-offer" required>
                                                <option value="rent" {{ $property->offer == 'rent' ? 'selected' : '' }}>
                                                    For Rent
                                                </option>
                                                <option value="sale" {{ $property->offer == 'sale' ? 'selected' : '' }}>
                                                    For Sale
                                                </option>
                                            </select>
                                        </div><!-- .submit-property__group -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="submit-property__group" id="property_space">
                                            <label for="property-space" class="submit-property__label">Property Space
                                                *</label>
                                            <input type="text" name="space" value="{{ $property->type == "Flat" ? $property->space : '' }}" class="submit-property__field"
                                                   id="property-space"
                                                   required>
                                    ...
                                    <div class="col-md-4" id="property_room">
                                        <div class="submit-property__group">
                                            ...
                                            <select class="ht-field" name="total_room" id="property-room"
                                                    required>
                                                <option value="1" {{ $property->type == "Flat" && $property->total_room == 1 ? 'selected' : '' }}>1</option>
                                                <option value="2" {{ $property->type == "Flat" && $property->total_room == 2 ? 'selected' : '' }}>2</option>
                                                <option value="3" {{ $property->type == "Flat" && $property->total_room == 3 ? 'selected' : '' }}>3</option>
                                                <option value="4" {{ $property->type == "Flat" && $property->total_room == 4 ? 'selected' : '' }}>4</option>
                                                <option value="5" {{ $property->type == "Flat" && $property->total_room == 5 ? 'selected' : '' }}>5</option>
                                            </select>
                                        </div><!-- .submit-property__group -->
                                    </div><!-- .col -->
                                </div><!-- .row -->
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="submit-property__group">
                                            <label for="property-address" class="submit-property__label">Address
                                                *</label>
                                            <input type="text" value="{{ $property->address }}" name="address" class="submit-property__field"
                                                   id="property-address">
                                        </div><!-- .submit-property__group -->
                                    </div><!-- .col -->
                                    <div class="col-md-4">
                                        <div class="submit-property__group">
                                            <label for="property-address" class="submit-property__label">Available from
                                                *</label>
                                            <input type="text" name="date"
                                                   class="property__form-field property__form-date" placeholder="Monday"
                                                   data-format="l, F d, Y" data-min-year="2017" data-max-year="2020"
                                                   data-translate-mode="true" data-modal="true" data-large-mode="true"
                                                   required>
                                        ...
                                        <div class="submit-property__group">
                                            ...
                                            <select class="ht-field" name="city" id="property-city" required>
                                                @foreach(\App\City::all() as $city)
                                                    <option value="{{ $city->name }}" {{ $property->city == $city->name ? 'selected' : '' }}>{{ $city->name }}</option>
                                                @endforeach
                                            </select>
                                        </div><!-- .submit-property__group -->
                                    </div><!-- .col -->
                                    <div class="col-md-4" id="property_room">
                                        <div class="submit-property__group">
                                            <label for="property-areas" class="submit-property__label">Area
                                                *</label>
                                            <input type="text" value="{{ $property->area }}" name="areas"
                                                   class="submit-property__field"
                                                   id="property-areas"
                                                   required>
                                    ...
                                    <div class="col-md-4" id="property_room">
                                        <div class="submit-property__group">
                                            <label for="property-areas" class="submit-property__label">Contact number
                                                *</label>
                                            <input type="tel" name="contact" value="{{ $property->contact }}"
                                                   class="submit-property__field"
                                                   id="property-areas"
                                                   required>
                                ...
                                <div class="submit-property__group">
                                    ...
                                    <textarea name="description"
                                              id="submit-property-wysiwyg">{{ $property->description }}</textarea>
                                </div><!-- .submit-property__group -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="submit-property__group">
                                            ...
                                            <select id="property-bedrooms" name="bedrooms" class="ht-field">
                                                <option value="1" {{ $property->type == "Flat" && $property->bedrooms == 1 ? 'selected' : '' }}>1</option>
                                                <option value="2" {{ $property->type == "Flat" && $property->bedrooms == 2 ? 'selected' : '' }}>2</option>
                                                <option value="3" {{ $property->type == "Flat" && $property->bedrooms == 3 ? 'selected' : '' }}>3</option>
                                                <option value="4" {{ $property->type == "Flat" && $property->bedrooms == 4 ? 'selected' : '' }}>4</option>
                                                <option value="5" {{ $property->type == "Flat" && $property->bedrooms == 5 ? 'selected' : '' }}>5</option>
                                            </select>
                                        </div><!-- .submit-property__group -->
                                    </div><!-- .col -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="submit-property__group">
                                            ...
                                            <select id="property-bathrooms" name="bathrooms" class="ht-field">
                                                <option value="1" {{ $property->type == "Flat" && $property->bathrooms == 1 ? 'selected' : '' }}>1</option>
                                                <option value="2" {{ $property->type == "Flat" && $property->bathrooms == 2 ? 'selected' : '' }}>2</option>
                                                <option value="3" {{ $property->type == "Flat" && $property->bathrooms == 3 ? 'selected' : '' }}>3</option>
                                                <option value="4" {{ $property->type == "Flat" && $property->bathrooms == 4 ? 'selected' : '' }}>4</option>
                                                <option value="5" {{ $property->type == "Flat" && $property->bathrooms == 5 ? 'selected' : '' }}>5</option>
                                            </select>
                                        </div><!-- .submit-property__group -->
                                    </div><!-- .col -->
                                    <div class="col-md-4">
                                        <div class="submit-property__group">
                                            ...
                                            <input type="text" value="{{ $property->parking }}" name="parking" class="submit-property__field"
                                                   id="property-parking">
                                        </div><!-- .submit-property__group -->
                                    </div><!-- .col -->
                                </div><!-- .row -->
                                ...
                                <div class="submit-property__features">
                                    <div class="submit-property__group">
                                        ...
                                        <div class="submit-property__wrapper">
                                            <input type="checkbox" {{ $property->is_air_condition ? 'checked' : '' }} name="is_air_condition" id="air-conditioning"
                            ...
                            <button type="submit" class="submit-property__submit">Update</button>
                        </div><!-- .col -->
                    </form>
                </div><!-- .row -->
...
@section('scripts')
    <script>
        $(document).ready(function () {
            var li = $('#dk0-listbox').find('li.dk-option-selected');
            console.log(li.text().trim());
            if (li.text().trim() !== "Flat") {
