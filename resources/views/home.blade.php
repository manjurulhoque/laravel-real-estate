        ...
        <div class="topbar">
            <ul class="topbar__contact">
                <li>
                    ...
                    <a href="tel:8801962126456" class="topbar__link">(+880)1745045851</a>
                </li>
                <li>
                    <span class="ion-ios-email-outline topbar__icon"></span>
                    <a href="" class="topbar__link">ReaEstate@support
                        .com</a>
                </li>
            </ul><!-- .topbar__contact -->
        ...
        <div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.6">
            <ul>
                ...
                <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                    ...
                    <!-- LAYER NR. 3 -->
                    <a href="https://www.youtube.com/watch?v=D69VhdRNok0" data-lity class="tp-caption   tp-resizeme"
...
<section class="partners">
    <div class="container">
        <ul class="partners__list">
            ...
            <li><img src="images/uploads/partner3.jpg" alt="Partner"></li>
...
<footer class="footer">
            ...
            <div class="row">
                <div class="col-sm-8 col-md-4 footer__links-single">
                    ...
                    <ul class="footer__list">
                        <li><span class="footer--highlighted">Address:</span> <a href="#">200 East 65th Street 17NO, New
                                York</a></li>
                        <li><span class="footer--highlighted">Email:</span> <a
                                    href="mailto:ReaLand@support.com">ReaLand@support.com</a></li>
                        <li><span class="footer--highlighted">Phone:</span> <a href="tel:+8802993999">(880)-288-3999</a>
                        </li>
    ...
    <div class="footer__main">
        <div class="container">
            ...
            <p class="footer__desc">ReaLand is made for buying and selling houses faster, easier and customized for
                you.</p>
        ...
        <div class="container">
            <div class="footer__copyright-inner">
                <p class="footer__copyright-desc">
                    &copy; 2018 <span class="footer--highlighted">ReaLand</span> Real Estate. All Right Reserved.
                </p>
